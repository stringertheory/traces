...
# manual, or own class]).
latex_documents = [
    (master_doc, 'traces.tex', u'traces Documentation',
     u'Mike Stringer', 'manual'),
]

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [
    (master_doc, 'traces', u'traces Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'traces', u'traces Documentation',
     author, 'traces', 'One line description of project.',
     'Miscellaneous'),
]
