...
class TestJsonIO:
    ...
    def test_from_json_invalid_format(self):
        ...
        with pytest.raises(ValueError, match="JSON data must be either a list or dictionary"):
    ...
    def test_from_json_missing_source(self):
        ...
        with pytest.raises(ValueError, match="Either filename or json_string must be provided"):
